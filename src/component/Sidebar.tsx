  ...
  return (
    <nav className='w-30 mx-0 h-full p-2'>
        <ul className='flex flex-col justify-center'>
            ...
            <li className='border border-white text-center border-b-0 p-4 text-xl cursor-pointer hover:bg-red-700 bg-red-400 text-white'>Charts</li>
            <li className='border border-white text-center p-4 text-xl cursor-pointer hover:bg-red-700 bg-red-400 text-white'>Maps</li>
        </ul>
    </nav>
  )
}
